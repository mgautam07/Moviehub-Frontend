  ...
  return (
    <>
        ...
        <Grid container spacing={2} sx={{mb:4}}>
            ...
            <Grid item>
            <Button variant="outlined" color="secondary" sx={{mt: 3, ml: 4}} onClick={handleSearch}>Seacrh</Button>
            </Grid>
        </Grid>
        {card1 ? <><Typography sx={{ml : 4}} variant='h3' color="secondary"> Search result movies</Typography>
        <Grid container sx={{justifyContent: 'center', mb:7, mt : 3}} >
            {card1}
        </Grid> </>: <></>}
        
        {card2 ? <><Typography sx={{ml : 4}} variant='h3' color="secondary"> Search result shows</Typography>
        <Grid container sx={{justifyContent: 'center', mb:7, mt : 3}} >
            {card2}
        </Grid></> : <></>}
    </>
